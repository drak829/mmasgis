...
public class GetValueServTask extends Task{
	DBManager db;
	@Override
	public void doTask(HttpServletRequest request, HttpServletResponse response) {
		...
		ArrayList<HashMap<String, Object>> tc_ser_id = new ArrayList<HashMap<String, Object>>();
		...
		if(db.connetti()) {
			String query=String.format(Const.getIdValueServ,censimento,valore);
			tc_ser_id=db.eseguiQueryObject(query, true);
			
		}
		jsonEncode(tc_ser_id,out);
	}
