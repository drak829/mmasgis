	...
	public void doTask(HttpServletRequest request, HttpServletResponse response) {
		...
		if (db.connetti()) {
			...
			if (db.eseguiAggiornamento(tabellaTemporanea)) {
				...
				String query = String.format(Const.analisiMarcheAz, base_num, base_pot, base_pot, base_num, base_pot, censimento, censimento, censimento, censimento, classeId, sortName, order);
