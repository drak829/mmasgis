...
public class GetValueMarTask extends Task{
	DBManager db;
	@Override
	public void doTask(HttpServletRequest request, HttpServletResponse response) {
		...
		ArrayList<HashMap<String, Object>> tc_mar_id = new ArrayList<HashMap<String, Object>>();
		...
		if(db.connetti()) {
			String query=String.format(Const.getIdValueMar,censimento,valore);
			tc_mar_id=db.eseguiQueryObject(query, true);
		}
		jsonEncode(tc_mar_id,out);
	}
