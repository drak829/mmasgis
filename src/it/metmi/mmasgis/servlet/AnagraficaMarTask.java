 ...
 *
 */
public class AnagraficaMarTask extends Task{
	...
	public void doTask(HttpServletRequest request, HttpServletResponse response) {
		...
		if(db.connetti()) {
				...
				String elencoMarche = String.format(Const.queryAllBrandsPerClass,brand_id,classeId);
				result= db.eseguiQuery(elencoMarche, true);
