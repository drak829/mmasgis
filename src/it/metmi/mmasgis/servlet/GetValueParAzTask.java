 ...
 *
 */
public class GetValueParAzTask extends Task{
	DBManager db;
	@Override
	public void doTask(HttpServletRequest request, HttpServletResponse response) {
		...
		ArrayList<HashMap<String, Object>> tc_par_az_id = new ArrayList<HashMap<String, Object>>();
		...
		if(db.connetti()) {
			String query=String.format(Const.getIdValueParAz,censimento,valore,classeId);
			tc_par_az_id=db.eseguiQueryObject(query, true);
		}
		jsonEncode(tc_par_az_id,out);
	}
