 ...
 * alla classe di marche AZIENDALI ottenuta come parametro
 *
 */
public class BrandsValuesAziendaList extends Task {
	...
	/**
	 * Dati il censimento, l'ID del punto vendita e l'ID della classe marca AZIENDALE,
	 * estrae dal censimento personalizzato i valori delle marche AZIENDALI del
	 * punto vendita specificato.
	 * <p>
	 * Per esempio, dati:
	 * <p>
	 * <code>
	 ...
	 * classe_id = 1
	 * <p>
	 * censimento: "farmacerp1101cicarelli"
	 * </code>
	 * <p>
	 * Viene estratto:
	 * <p>
	 * <code>
	 * "Prodotti Podologici" : "Dr. Scholl (SSL Healthcare)"
	 * </code>
	 * 
	 */
	@Override
	public void doTask(HttpServletRequest request, HttpServletResponse response) {
		...
		String query = String.format(Const.queryValMarAz, pvId, brandId);
