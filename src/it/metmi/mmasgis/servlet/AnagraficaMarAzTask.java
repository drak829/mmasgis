 ...
 *
 */
public class AnagraficaMarAzTask extends Task{
	...
	public void doTask(HttpServletRequest request, HttpServletResponse response) {
		...
		String classeAzId=request.getParameter("classeAzId");	
		String brand_az_id=request.getParameter("brand_az_id");
		...
		if(db.connetti()) {
				...
				String elencoMarcheAz = String.format(Const.queryAllBrandsAzPerClass,brand_az_id,classeAzId);
				result= db.eseguiQuery(elencoMarcheAz, true);
